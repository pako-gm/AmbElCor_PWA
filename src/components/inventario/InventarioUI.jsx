...
export function Icon({ name, size = 18, style }) {
  ...
  const paths = {
    ...
    eyeOff: (
      <>
        <path d="M17.9 17.9A9.9 9.9 0 0 1 12 20C6.5 20 2 12 2 12a17.6 17.6 0 0 1 5.1-5.9M9.9 4.2A9.2 9.2 0 0 1 12 4c5.5 0 10 8 10 8a17.7 17.7 0 0 1-2.1 3.1" />
        <path d="M10.6 10.6a3 3 0 1 0 3.8 3.8" />
        <path d="M2 2l20 20" />
      </>
    ),
